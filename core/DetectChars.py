...
def loadKNNDataAndTrainKNN():
    ...
    try:
        npaClassifications = np.loadtxt("C:\Users\Deji Salau\PycharmProjects\PlateRecognition\core\classifications.txt", np.float32)                  # read in training classifications
    ...
    try:
        npaFlattenedImages = np.loadtxt("C:/Users/Deji Salau/PycharmProjects/PlateRecognition/core/flattened_images.txt", np.float32)                 # read in training images
    except Exception as error:
        print error# if file could not be opened
