...
def loadKNNDataAndTrainKNN():
    ...
    try:
        npaClassifications = np.loadtxt("/home/lekanterragon/Desktop/PlateRecognition/classifications.txt", np.float32)                  # read in training classifications
    ...
    try:
        # define image path
        npaFlattenedImages = np.loadtxt("image_path", np.float32)                 # read in training images
    except Exception as error:
        print error
